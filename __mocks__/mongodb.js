import { clone, length, times, zipObj } from 'ramda';
...
export const MockDatabase = { collection: jest.fn(() => clone(MockCollection)) };
export const MockConnection = { db: jest.fn(() => clone(MockDatabase)) };
